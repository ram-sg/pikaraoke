...
from biaoke.lib.metadata_parser import (
...
class TestRateLimiting:
    ...
    @patch("biaoke.lib.metadata_parser.time.sleep")
    @patch("requests.get")
...
class TestHasYoutubeId:
    ...
    def test_full_path_biaoke(self):
...
class TestProvenanceRouting:
    ...
    @patch("biaoke.lib.metadata_parser.lookup_lastfm")
