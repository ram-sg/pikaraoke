...
class TestQueueManagerHelpers:
    ...
    def test_is_user_limited_returns_false_for_biaoke_user(self, preferences, events):
        """Biaoke system user should never be limited."""
        ...
        assert qm.is_user_limited("Biaoke") is False
